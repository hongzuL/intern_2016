function [UTRP,straghtLine]=mainAlgorithm_UTRP(filename)
    input_features=0;
    delimiter = ',';
    startRow = 2;
    ...
    [I,II,III,AVR,AVL,AVF,V1,V2,V3,V4,V5,V6,TIME]=signalProcessing(TIME_ABSOLUTE,MDC_ECG_LEAD_I,MDC_ECG_LEAD_II,MDC_ECG_LEAD_III,MDC_ECG_LEAD_AVR,MDC_ECG_LEAD_AVL,MDC_ECG_LEAD_AVF,MDC_ECG_LEAD_V1,MDC_ECG_LEAD_V2,MDC_ECG_LEAD_V3,MDC_ECG_LEAD_V4,MDC_ECG_LEAD_V5,MDC_ECG_LEAD_V6);
